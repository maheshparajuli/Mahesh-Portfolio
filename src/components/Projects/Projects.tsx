...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Created an advanced sentiment analysis tool using transformer models that processes social media data to provide real-time market insights.",
      icon: MessageSquare,
